    ...
    if request.method == "POST":
        ...
        if form1.validate() and form2.validate() and form3.validate():
            ...
            if len(raw_data1) == 0 and len(raw_data2) == 0 and len(raw_data3) == 0:
                # for form 1
                # has all the keys
                form1_data_dummy = copy.deepcopy(form1.data)
                form2_data_dummy = copy.deepcopy(form2.data)
                form3_data_dummy = copy.deepcopy(form3.data)

                for name in form1_data_dummy.keys():
                    try:
                ...
                # for form 2
                for name in form2_data_dummy.keys():
                    try:
                ...
                # for form 3
                for name in form3_data_dummy.keys():
                    try:
...
def detail():
    ...
    if request.method == "POST":
        ...
        if len(raw_data1) == 0:
            ...
            for index in range(len(values1)):
                value = values1[index]
                if "checkbox" in names1[index]:
                    if values1[index] == "y":
                        value = True
                data_form1[names1[index]] = value
            form1 = forms.Form1Form(data=data_form1)
            ...
            for index in range(len(values2)):
                value = values2[index]
                if "checkbox" in names2[index]:
                    if values2[index] == "y":
                        value = True
                data_form2[names2[index]] = value
            form2 = forms.Form2Form(data=data_form2)
            ...
            for index in range(len(values3)):
                value = values3[index]
                if "checkbox" in names3[index]:
                    if values3[index] == "y":
                        value = True
                data_form3[names3[index]] = value
            form3 = forms.Form3Form(data=data_form3)
